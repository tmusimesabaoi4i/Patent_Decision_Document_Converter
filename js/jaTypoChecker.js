(function (root) {
  ...
  function createJaTypoChecker() {
    ...
    },
    {
      ...
      // - 対象の助詞: は・が・を・に・へ・と・で・から・まで・より・や・か・も・の
      // - 直前に漢字／かな／数字が 1〜8 文字あるものだけを対象として、
      //   単語の一部ではなく「助詞」として使われている可能性が高い箇所に絞っている。
      // 「ことと」（「こと」+助詞「と」）は誤検出しやすいので除外する
      regex: /([一-龥ぁ-んァ-ン0-9０-９]{1,8})(は|が|を|に|へ|と|で|から|まで|より|や|か|も)(?<!こと)\2/g,
