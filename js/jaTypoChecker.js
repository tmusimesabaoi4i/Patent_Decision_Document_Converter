(function (root) {
  ...
  function createJaTypoChecker() {
    ...
    {
        id: "duplicatedParticleNo",
        // 「〜のの〜」のように助詞「の」が重複しているケースをざっくり検出
        // 先行語 + 「の」の直後にさらに「の」が続くパターン
        regex: /([一-龥ぁ-んァ-ン0-9０-９]{1,8}の)の/g,
        message: "助詞「の」が続けて現れています。不要な「の」が入っている可能性があります。",
    },
    {
        id: "duplicatedParticleGa",
        // 「〜がが〜」のように助詞「が」が重複しているケース
        regex: /([一-龥ぁ-んァ-ン0-9０-９]{1,8}が)が/g,
        message: "助詞「が」が続けて現れています。不要な「が」が入っている可能性があります。",
    },
    {
